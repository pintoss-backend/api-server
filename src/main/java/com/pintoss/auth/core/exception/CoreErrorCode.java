...
public enum CoreErrorCode {
    ...
    CART_ITEM_ALREADY_DELETED("CART_ITEM_ALREADY_DELETED", "이미 삭제된 장바구니 아이템입니다."),
    INVALID_CART_ITEM_QUANTITY("4009", "장바구니 아이템의 수량이 유효하지 않습니다."),
    ...
    ORDER_ITEM_NOT_FOUND("40018", "주문 항목을 찾을 수 없습니다."),
    // Payment Errors
